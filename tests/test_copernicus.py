        ...
        with temp_dir(
            ...
            with Download(user_agent="test") as downloader:
                ...
                assert dataset == {
                    ...
                    "notes": "Open and free data for assessing the human presence on the "
                    "planet.\r\nThe Global Human Settlement Layer (GHSL) project produces global "
                    "spatial information, evidence-based analytics, and knowledge "
                    "describing the human presence on the planet. The GHSL relies on the "
                    "design and implementation of spatial data processing technologies "
                    "that allow automatic data analytics and information extraction from "
                    "large amounts of heterogeneous geospatial data including global, "
                    "fine-scale satellite image data streams, census data, and crowd "
                    "sourced or volunteered geographic information sources.  \r\n"
                    "The JRC, together with the Directorate-General for Regional and "
                    "Urban Policy (DG REGIO) and Directorate-General for Defence "
                    "Industry and Space (DG DEFIS) are working towards a regular and "
                    "operational monitoring of global built-up and population based on "
                    "the processing of Sentinel Earth Observation data produced by "
                    "European Copernicus space program. In addition, the EU Agency for "
                    "the Space Programme (EUSPA) undertakes activities related to user "
                    "uptake of data, information and services.",
                    "methodology": "Other",
                    "methodology_other": "The GHSL relies on the design and implementation of "
                    "spatial data processing technologies that allow "
                    "automatic data analytics and information extraction "
                    "from large amounts of heterogeneous geospatial data "
                    "including global, fine-scale satellite image data "
                    "streams, census data, and crowd sourced or volunteered "
                    "geographic information sources.  \r\n\r\nMethodology "
                    "[link](https://human-settlement.emergency.copernicus.eu/documents/GHSL_Data_Package_2023.pdf?t=1727170839).",
                    ...
                    "multitemporal (1975-2030). European Commission, Joint Research "
