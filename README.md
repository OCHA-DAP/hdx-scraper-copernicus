...
This script downloads GHS data from the [GHSL FTP](https://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/GHSL/) and drought data from the [Copernicus FTP](https://drought.emergency.copernicus.eu/data/Drought_Observatories_datasets/). It processes them into global and country level datasets on HDX. It downloads around 1000 files from the FTPs and one boundary file from HDX, and makes around 600 update calls to HDX.
 ...
 **hdx-scraper-copernicus** as specified in the parameter
 *user_agent_lookup*.
